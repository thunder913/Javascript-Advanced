...
class Pet{
    ...
    toString(){
        let toReturn = `Here is ${this.owner}'s pet ${this.name}.`;
...
class Cat extends Pet{
    ...
    toString(){
        ...
        if (this.scratching) {
            toReturn += ", but beware of scratches.";
        }
        return toReturn;
    }
}
...
class Dog extends Pet{
    ...
    toString(){
        let toReturn = super.toString();
        toReturn += "\nMain information:\n"
        toReturn += `${this.name} is a dog with need of ${this.runningNeeds}km running every day and ${this.trainability} trainability.`
        return toReturn;
    }
}
